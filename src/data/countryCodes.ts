...
// Real flag artwork instead of the regional-indicator emoji: Windows has no
// color flag glyphs in its system font, so those emoji render as bare
// two-letter codes (US, IN, ...) rather than a flag on most Windows Chrome
// installs. flagcdn's free SVGs render identically on every OS.
